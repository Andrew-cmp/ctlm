...
def main():
    ...
    err_queue = Queue()
    sketch_dic_list_i = sketch_dic_list[0:]
    ...
    device = "cuda:0"
    worker(err_queue, script_args.save_path, sketch_dic_list_i, hash_task_i, dataset_path, gen_kwargs, tokenizer, script_args.model_name_or_path, device, script_args.allow_repeat, script_args.keep_cnt, script_args.is_build)
