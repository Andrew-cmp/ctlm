...
@dataclass
class MixOfAdapterFineTuningArguments:

        start_finetuning: bool =field(
            default = False,metadata = {"help":""},
          )
        adapter_name: str =field(
            default = "bottleneck",metadata = {"help":""},
          )
        ...
        use_parallel_adapter: bool =field(
            default = False,metadata = {"help":""},
          )
        use_adapterp: bool =field(
            default = False,metadata = {"help":""},
          )
        target_modules: List[str] =field(
            default = None,metadata = {"help":""},
          )
        scaling: Union[float, str] =field(
...
def main():
    ...
    if adapter_args.adapter_name == "lora":
        pass
    elif adapter_args.adapter_name == "bottleneck":
    ...
    if(adapter_args.start_finetuning):
