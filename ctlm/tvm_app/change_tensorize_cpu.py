...
if is_change:
    ...
    assert len(schs) > 0
    sch = schs[0]
    # with open(str("/home/zhwang/tvm/tvm_app/sch_trace_cpu.py"),'w') as f:
    #     f.write(str(sch.trace))
    with open(str("/home/zhwang/trash.print/sch_trace_cpu2.py"),'w') as f:
        f.write(str(sch.trace))
    with open(str("/home/zhwang/trash.print/mod_cpu2.py"),'w') as f:
        f.write(str(sch.mod))
else:
